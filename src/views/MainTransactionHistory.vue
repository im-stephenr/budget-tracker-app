...
<template>
  ...
  <div class="overflow-x-auto p-2">
    <div class="overflow-hidden">
      ...
      <!-- Card -->
      <div v-for="(items, month_year) in transaction_list" :key="month_year">
        ...
        >
          <h1 class="font-bold inline-block text-lg">{{ list.product }}</h1>
          <div class="inline">
            <!-- BUTTONS -->
            <router-link
              :to="{ name: 'Edit Transaction', params: { id: list.id } }"
              @click="updatePage"
            ...
            <button
              type="button"
              @click.prevent="handleDelete(list.id, list.image_path)"
          ...
          <div class="w-full flex">
            ...
            <div class="w-70 flex ml-2">
              <div class="w-60">
                <!-- PURCHASE SOURCE -->
                <h1 class="font-medium text-sm">{{ list.category }}</h1>
                <!-- PURPOSE -->
              ...
              <div class="w-40 relative">
                ...
                <!-- PAYMENT METHOD -->
                <p class="text-xs absolute bottom-8 text-red-300">
                  {{ list.payment_method }}
                </p>
              </div>
            </div>
